...
Esta lista de exercícios tem como objetivo reforçar os conceitos iniciais de programação, com foco em:
...
```bash
git clone https://github.com/augusto-hermes/codifica-list01.git
```
